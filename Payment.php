	...
	<div class="container">
		...
		<form action="ajax.php" method="post">
			...
			<div class="row">
				...
				<div class="col">
					<h3 class="title">Payment <span class="pay_price">213$</span></h3>
					<div class="inputBox">
						<label for="name">
							Card Accepted:
						</label>
					...
					<div class="inputBox">
						<label for="s">Exp Month:</label>
						<select name="exp_month" id="s">
					...
					<div class="flex">
						<div class="inputBox">
							<label for="s">Exp Year:</label>
							<select name="exp_year" id=""s>
			...
			<input type="submit" name="payment" value="Proceed to Checkout" class="submit_btn">
		</form>
